            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16"
                ...
                >
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.02)] hover:bg-[rgba(255,255,255,0.05)] text-[#d4b89e] text-sm font-medium transition-all duration-200 mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
                        onClick={async () => {
